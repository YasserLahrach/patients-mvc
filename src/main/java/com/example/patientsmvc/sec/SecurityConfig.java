...
import com.example.patientsmvc.sec.service.UsersDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.jdbcAuthentication()
                ...
                .usersByUsernameQuery("select username as principal, password as credentials, active as active from users where username=?")
